...
/**
 * 默认具有Title和loading状态的Fragment
 */

public abstract class TitleLoadingFragment extends BaseFragment {
  ...
  protected View layoutView() {
    ...
    View root = LayoutInflater.from(getActivity()).inflate(layoutResID(), vLoading, false);
