...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyImage = a.getResourceId(R.styleable.LoadingLayout_llEmptyImage, R.drawable.empty);
        mEmptyText = a.getString(R.styleable.LoadingLayout_llEmptyText);

        mErrorImage = a.getResourceId(R.styleable.LoadingLayout_llErrorImage, R.drawable.error);
