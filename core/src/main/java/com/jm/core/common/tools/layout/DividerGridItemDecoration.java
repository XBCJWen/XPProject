...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Drawable divider) {
        mDivider = divider;
        leftRight = mDivider.getIntrinsicWidth();
        topBottom = mDivider.getIntrinsicHeight();
    }

    public DividerGridItemDecoration(Drawable divider, int leftRight, int topBottom) {
        mDivider = divider;
